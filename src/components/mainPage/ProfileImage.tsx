  ...
  return (
    <div className="hidden md:block relative mt-12 md:mt-0">
      <div className="w-64 h-64 rounded-2xl bg-gradient-to-br from-teal-600 to-blue-400 shadow-xl flex items-center justify-center">
        <div className="absolute -top-3 -left-3 w-12 h-12 rounded-lg bg-teal-800 flex items-center justify-center text-white">
          <Code size={24} />
        </div>
        <div className="absolute -bottom-3 -right-3 w-12 h-12 rounded-lg bg-blue-600 flex items-center justify-center text-white">
          <Briefcase size={24} />
        </div>
